# assemble data through latest year (2018), first w/o HC
...
pop <- read.csv("data/census/PEP_2018_PEPANNRES_cleaner.csv", stringsAsFactors = FALSE)
#pop <- pop[grepl("Nebraska", pop$Geography),] #already cut to NE
...
# 
# HC18 <- read.csv("data/Arbonet/oldArbonet/prelim_2018_HC.csv", stringsAsFactors = FALSE)
