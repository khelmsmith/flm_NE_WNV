...
Note: It takes a while to run all the models. Users not interested in the full set can comment some out in flm.r. 
...
```{r}
flm:::extract_functional(flm.results[[3]]$fittedModels[[top]])
