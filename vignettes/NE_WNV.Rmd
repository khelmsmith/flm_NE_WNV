...
# if you have actual case data, load that here and set in.seed = NULL
# in the call to assemble.data below
...
flm.results = call.flm(pop, cases, NEdat, spi, spei, target.date, start.year, in.seed, lag.lengths)
