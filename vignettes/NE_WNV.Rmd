...
data <- assemble.data.lags(pop, cases, NEdat, spi, spei, 
                           target.date = "2018-02-02", start.year = 2002, in.seed = 4872957, lag.lengths = 12)
...
flm.results = flm::call.flm(pop, cases, NEdat, spi, spei, target.date, start.year, in.seed = 4872957, lag.lengths = c(12, 18, 24, 30, 36))
