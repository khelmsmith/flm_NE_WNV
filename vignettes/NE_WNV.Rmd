...
allLagsT <- data[[1]] # 2004 - 2018
allLags0 <- data[[2]] # 2019
...
missingunits <- !(allunits %in% unique(allLags0$County))
...
flm.results = call.flm(pop, cases, NEdat, spi, spei, target.date, start.year, in.seed = in.seed, lag.lengths)
